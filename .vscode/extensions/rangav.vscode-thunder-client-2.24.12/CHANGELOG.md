...
# [v2.24.0](https://github.com/rangav/thunder-client-support/releases/tag/v2.24.0) - (2024-05-23)

## Features Moving to Paid Version

The following features will be moved to the paid version starting on `3rd June, 2024`.

- [Request Chaining](https://docs.thunderclient.com/features/request-chaining)
- [Response Visualization](https://docs.thunderclient.com/testing/chart-view)
- [Import Node Modules](https://docs.thunderclient.com/scripting/libraries)
- [Script Assertions](https://docs.thunderclient.com/scripting/assertions)
- [Requests in Scripts](https://docs.thunderclient.com/scripting/send-request)
- [Import JS Files](https://docs.thunderclient.com/scripting/import-files)
...
- Please see **Individual plan features** on our [pricing page](https://www.thunderclient.com/pricing).

### Questions

- If you have any questions, please contact us using [this form](https://www.thunderclient.com/contact).
